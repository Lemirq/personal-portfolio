...
const sections = [
	...
	},
	{
		label: (
			<>
				<Logo variant="white" pathClassName="group-hover:fill-indigo-500 transition-colors" svgPathName="hidden md:block" size="32px" />
				<Logo variant="white" pathClassName="group-hover:fill-indigo-500 transition-colors" svgPathName="block md:hidden" size="16px" />
			</>
		),
		url: 'https://vhaan.me',
