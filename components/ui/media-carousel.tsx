...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="perspective-distant transform-3d">
      ...
      >
        <div
          className="absolute top-0 left-0 w-full h-full bg-[#0f1821] rounded-[1%] overflow-hidden transition-all duration-150 ease-out"
          style={{
            transform:
              current === index
...
const CarouselControl = ({
  ...
  return (
    <button
      className={`w-10 h-10 flex items-center mx-2 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-[#6D64F7] focus:outline-hidden hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
